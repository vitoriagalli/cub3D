...
/*   Updated: 2020/06/01 04:01:35 by vscabell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_player(t_vars *vars)
{
	...
	// coloca o jogador e seu fov no mapa 2d conforme sua atualização
	map2d_player(vars);

	// calcula pra cada raio do fov a distancia ate a parede mais próxima
	// faz dois tipos de iterações: vertical e horizontal
	// retorna cada raio com sua info: dist_min, angle, h/v, ponto de colisão
